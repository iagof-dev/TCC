...
export default function CoverOption(props) {
    ...
    return (
        <div className="w-[18rem] h-[28rem] relative" id={`cover-${id}`} onClick={() => {
            ...
            {selectedCoverID == id? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#e7e7e7" className="w-32 h-32  absolute bottom-[10rem] left-[5rem]">
